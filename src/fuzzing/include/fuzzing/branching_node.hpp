...
struct  branching_node final
{
    ...
    bool  was_minimization_performed() const { return minimization_performed; }
    ...
    bool  has_pending_analysis() const { return !sensitivity_performed || (!sensitive_stdin_bits.empty() && (!bitshare_performed || !minimization_performed)); }
    ...
    natural_32_bit  get_minimization_start_execution() const { return minimization_start_execution; }
    ...
    void  set_minimization_performed(natural_32_bit  execution_id);
