...
struct  sensitivity_fuzzer_progress_check : public sensitivity_fuzzer_base
{
    sensitivity_fuzzer_progress_check(
            ...
            execution_trace_weak_ptr  original_trace_,
            sensitivity_fuzzer_base_weak_ptr  parent,
            bool  similarity_only_for_uncovered_branchings_
            );

    [[nodiscard]] execution_trace_ptr  get_original_trace() const { return original_trace.lock(); }
...
private:
    execution_trace_weak_ptr  original_trace;
